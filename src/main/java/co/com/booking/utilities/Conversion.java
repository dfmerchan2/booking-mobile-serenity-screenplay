...
import static co.com.booking.utilities.Constants.FORMAT_DATE_WITH_SLASH;
import static co.com.booking.utilities.Constants.FORMAT_DATE_WITH_SPACES;
...
public class Conversion {
  ...
  public static String formatDate(String date) {
    ...
    DateTimeFormatter formatter1 = DateTimeFormatter.ofPattern(FORMAT_DATE_WITH_SPACES, Locale.US);
  ...
  public static String formateDateCheck(String date) {
    DateTimeFormatter dateTimeFormatter =
        DateTimeFormatter.ofPattern(FORMAT_DATE_WITH_SPACES, Locale.ENGLISH);
