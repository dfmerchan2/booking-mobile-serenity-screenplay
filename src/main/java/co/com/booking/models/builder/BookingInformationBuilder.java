...
import static co.com.booking.utilities.Constants.MESSAGE_YOU_SELECTED;
import static co.com.booking.utilities.Conversion.*;

@AllArgsConstructor(access = AccessLevel.PRIVATE)
public class BookingInformationBuilder {

  public static BookingInformation bookingInformation(
      String destination, List<Map<String, String>> data) {
  ...
  public static BookingInformation getDataSummary(
      BookingInformation dataBooking, String hotelName, String priceHotel) {
    return BookingInformation.builder()
        .nameHotel(hotelName)
        .checkIn(formateDateCheck(dataBooking.getCheckIn()))
        .checkOut(formateDateCheck(dataBooking.getCheckOut()))
        .youSelected(
            String.format(MESSAGE_YOU_SELECTED, dataBooking.getAdults(), dataBooking.getChildren()))
