...
import static co.com.booking.utilities.Constants.FINGER;
import static co.com.booking.utilities.MyDriver.getDriverAppium;
  ...
  public <T extends Actor> void performAs(T actor) {
    ...
    sequence.addAction(
        finger.createPointerMove(
            Duration.ofMillis(700), PointerInput.Origin.viewport(), endX, endY));
