...
public class HotelsListPage {
  ...
  public static final Target LST_HOTELS =
      Target.the("hotel list").located(By.id("com.booking:id/results_list_facet"));
  public static final Target BTN_CLOSE_BANNER =
      Target.the("Close banner button").located(By.id("com.booking:id/bui_banner_close_button"));
}
